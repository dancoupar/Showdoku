namespace Showdoku.Setup
{
	public class GridBuilder
	{
		...
		public GridBuilder WithMediumGrid_D()
		{
			foreach (Cell cell in grid.Cells)
			{
				cell.Empty();
		...
		public GridBuilder WithHardGrid_B()
		{
			...
			grid.Cells[2, 0].Solve(6);
			grid.Cells[3, 1].Solve(8);
			grid.Cells[4, 1].Solve(7);
			grid.Cells[6, 1].Solve(6);
			grid.Cells[8, 1].Solve(9);
			grid.Cells[2, 2].Solve(1);
			grid.Cells[4, 2].Solve(5);
			grid.Cells[3, 3].Solve(7);
			grid.Cells[5, 3].Solve(4);
			grid.Cells[1, 4].Solve(7);
			grid.Cells[2, 4].Solve(9);
			grid.Cells[5, 4].Solve(2);
			grid.Cells[6, 4].Solve(5);
			grid.Cells[7, 5].Solve(3);
			grid.Cells[1, 6].Solve(1);
			grid.Cells[7, 6].Solve(6);
			grid.Cells[1, 7].Solve(8);
			grid.Cells[4, 7].Solve(1);
			grid.Cells[8, 7].Solve(3);
			grid.Cells[2, 8].Solve(4);
			grid.Cells[5, 8].Solve(3);
			grid.Cells[7, 8].Solve(9);
